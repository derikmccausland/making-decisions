...
if (amysAge > brittanisAge) {
  ...
  console.log('Any and Brittani are the same age.')
}
...
if (amysBirthYear === brittanisBirthYear) {
  console.log("Amy and Brittani have the same birth year") 
} else { 
  console.log("Amy and Brittani have different birth years")
}
////////// PROBLEM 4 //////////
...
if ( temperature >= 80 && rain === true ) {
  console.log("T-shirt and umbrella!")
    ...
    console.log("Wear a medium to heavy jacket")
  }
////////// PROBLEM 5 //////////
...
while (score < passingScore){
  console.log("Your score is too low")
  score ++
